...
/** Formatea un número como "$0.40" (o "-$0.40" si es negativo, para
 *  líneas de descuento — sin esto, números negativos salían como
 *  "$-0.40", con el signo en el lugar equivocado). */
