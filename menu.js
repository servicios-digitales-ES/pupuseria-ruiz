...
const _PRODUCTOS_DEMO = [
  { ID: 'F/Q',   Nombre: 'Frijol con Queso',      Tipo: 'Tradicional', Masa: 'Maiz/Arroz', Precio_unitario: 0.40 },
  { ID: 'RV',    Nombre: 'Revuelta',               Tipo: 'Tradicional', Masa: 'Maiz/Arroz', Precio_unitario: 0.40 },
  { ID: 'Q',     Nombre: 'Queso',                  Tipo: 'Especial',    Masa: 'Maiz/Arroz', Precio_unitario: 0.75 },
  { ID: 'LORO',  Nombre: 'Loroco con Queso',       Tipo: 'Especial',    Masa: 'Maiz/Arroz', Precio_unitario: 0.75 },
  { ID: 'CHI',   Nombre: 'Chicharron con Queso',   Tipo: 'Especial',    Masa: 'Maiz/Arroz', Precio_unitario: 0.75 },
  { ID: 'AYO',   Nombre: 'Ayote con Queso',        Tipo: 'Especial',    Masa: 'Maiz/Arroz', Precio_unitario: 0.75 },
  { ID: 'CHIPI', Nombre: 'Chipilin con Queso',     Tipo: 'Especial',    Masa: 'Maiz/Arroz', Precio_unitario: 0.75 },
  { ID: 'PO',    Nombre: 'Pollo con Queso',        Tipo: 'Especial',    Masa: 'Maiz/Arroz', Precio_unitario: 0.75 },
  { ID: 'JAM',   Nombre: 'Jamon con Queso',        Tipo: 'Especial',    Masa: 'Maiz/Arroz', Precio_unitario: 0.75 },
  { ID: 'JAL',   Nombre: 'Jalapeño con Queso',     Tipo: 'Especial',    Masa: 'Maiz/Arroz', Precio_unitario: 0.75 },
  { ID: 'AJO',   Nombre: 'Ajo con Queso',          Tipo: 'Especial',    Masa: 'Maiz/Arroz', Precio_unitario: 0.75 },
  { ID: 'MO',    Nombre: 'Mora con Queso',         Tipo: 'Especial',    Masa: 'Maiz/Arroz', Precio_unitario: 0.75 },
  { ID: 'LOCA',  Nombre: 'Pupusa Loca',            Tipo: 'Loca',        Masa: 'Maiz/Arroz', Precio_unitario: 0.75 },
];
